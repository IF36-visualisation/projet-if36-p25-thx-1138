...
Cette analyse des Jeux Olympiques a permis de confirmer certaines hypothèses, notamment que le nombre d’épreuves dans des disciplines comme la natation ou le ski de fond favorise les athlètes multi-médaillés, et que la participation globale a fortement augmenté au fil du temps, malgré des baisses ponctuelles liées à des événements politiques ou économiques. L’effet du pays hôte apparaît plus complexe et moins systématiquement bénéfique qu’on pourrait le penser, certaines nations hôtes profitant davantage que d’autres, sans que cela ne garantisse toujours une hausse significative des médailles. Par ailleurs, l’idée d’une uniformisation stricte des profils physiques des athlètes est nuancée, puisque si la taille reste assez stable au sein des disciplines, la variance du poids reflète une diversité liée aux spécialisations. Enfin, la répartition géographique des villes hôtes confirme un déséquilibre marqué, avec une forte concentration dans les pays du Nord, liée à des facteurs économiques et logistiques. Ce travail montre ainsi que les Jeux Olympiques sont le produit d’interactions complexes entre les performances sportives, les évolutions historiques, les caractéristiques physiques, et les choix géopolitiques.
