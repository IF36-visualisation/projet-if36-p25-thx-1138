...
### Question 3: Évolution des médailles entre 3 éditions avant et l'année hôte
...
(La version interactive de ce graphique est présente sur shiny app afin de visualiser la moyenne pour différents sports)
...
- De plus un graphique interactif est disponnible dans shinny 
...
Une carte interactive présentant l'évolution des pays participant au JO est disponnible en shinny
...
Pour tester ces hypothèses, nous allons visualiser l’évolution de la taille moyenne et du poids moyen des athlètes par discipline et par année, à l’aide de line graphs. Ces visualisations permettront d’identifier les tendances globales ainsi que les différences entre sports. (Les versions interactives de ces graphiques sont disponibles sur shiny app afin de visualiser les tendances pour différents sports)
...
Guillaume : "Ce projet m’a permis de découvrir concrètement l’analyse de données et la visualisation mais aussi de me familiariser avec le langage R. J’ai apprécié le transfert d'un de nos graphiques sur Tableau, qui montre bien la puissance d’un outil interactif de visualisation. En revanche, j’aurais aimé pouvoir travailler avec un dataset plus riche sur les athlètes pour approfondir les analyses des performances individuelles"

Élia : "J'ai pu approfondir mes compétences en R et découvrir davantage le travail de la donnée. Apprendre par l'expérience à réaliser des graphiques simples, lisibles, et pertinents m'a été bénéfique et me resservira probablement à l'avenir. J'aurai apprécié disposer de plus de temps et de moyens pour documenter les éléments découverts par la dataviz avec des données historiques."

Hippolyte : "Ce projet m’a permis d’améliorer mes compétences en R, notamment avec Shiny, un outil que j’ai trouvé très puissant pour créer des visualisations interactives. J’ai beaucoup apprécié le sujet des Jeux Olympiques, riche en données et en enjeux. Explorer la participation, les performances ou l’effet pays hôte a été très intéressant. J’aurais toutefois aimé me concentrer davantage sur certains sports pour approfondir l’analyse."
...
Guillaume :
  ...
  - Analyse de la corrélation entre l'âge des athlètes et leur performance dans certaines disciplines.
  - Réalisation de l’analyse morphologique (taille, poids, évolution dans le temps).
  - Étude sur l’organisation des Jeux Olympiques par ville hôte.
  - Intégration des graphiques correspondants dans l'application Shiny, permettant une exploration interactive du poids, de la taille et de l’âge moyen des médaillés par sport.

Élia :

  - Mise en évidence et analyse des disparités de genre parmi les athlètes


Hippolyte :
  -Analyse de la performance individuelle des athlètes
  -Étude sur l'évolution de la participation aux Jeux Olympiques
  -Réalisation de deux graphiques Shiny : une carte interactive de la participation aux JO ainsi qu'un bar chart des médailles
